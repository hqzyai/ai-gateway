...
export const pricingDimensions: PricingDimensionDefinition[] = [
  ...
  { key: "input_cost_per_video_per_second", label: "输入视频", category: "视频", unit: "美元 / 秒", scale: 1 },
  { key: "output_cost_per_video_per_second", label: "输出视频", category: "视频", unit: "美元 / 秒", scale: 1 },
  { key: "output_cost_per_second", label: "生成媒体", category: "视频", unit: "美元 / 秒", scale: 1 },
  {
