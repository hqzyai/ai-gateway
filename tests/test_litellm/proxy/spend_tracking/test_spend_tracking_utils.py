...
def test_sanitize_guardrail_information_preserves_headroom_compression_token_stats(
    ...
    guardrail_info = [
        {
            ...
            "guardrail_response": {
                ...
                "messages_before": [{"role": "user", "content": "original prompt"}],
                "messages_after": [{"role": "user", "content": "compressed prompt"}],
                "ccr_enabled": True,
    ...
    assert "messages_before" not in result[0]["guardrail_response"]
    assert "messages_after" not in result[0]["guardrail_response"]
