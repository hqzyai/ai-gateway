...
def test_get_provider_create_fields():
    ...
    siliconflow = next(provider for provider in response_data if provider["litellm_provider"] == "siliconflow")
    ...
    assert siliconflow["models"] == [
        ...
        "siliconflow/netease-youdao/bce-reranker-base_v1",
        "siliconflow/Qwen/Qwen3-Reranker-0.6B",
        "siliconflow/Qwen/Qwen3-Reranker-4B",
