...
class ModelInfoBase(ProviderSpecificModelInfo, total=False):
    ...
    output_cost_per_image_above_16384_tokens: float | None
    output_cost_per_image_token: float | None
    output_cost_per_video: float | None
    output_cost_per_video_token: float | None  # for gemini omni models with video output
    video_token_pricing: VideoTokenPricing | None
...
class CustomPricingLiteLLMParams(BaseModel):
    ...
    video_token_pricing: VideoTokenPricing | None = None
    ...
    output_cost_per_image_above_16384_tokens: float | None = None
    output_cost_per_image_token: float | None = None
    output_cost_per_video: float | None = None
