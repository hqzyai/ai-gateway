...
async def arerank(
    ...
    custom_llm_provider: (
        Literal["cohere", "together_ai", "deepinfra", "fireworks_ai", "voyage", "watsonx", "siliconflow"] | None
    ) = None,
    top_n: int | None = None,
    ...
    **kwargs,
    ...
    try:
        ...
        if (
            ...
            if api_base is None:
                raise Exception("Invalid api base. api_base=None. Set in call or via `COHERE_API_BASE` env var.")
            ...
            if api_base is None:
                raise Exception("Invalid api base. api_base=None. Set in call or via `INFINITY_API_BASE` env var.")
